...
export const AUDIENCE_CARDS: AudienceCard[] = [
  {
    ...
    description: "내 업종, 내 예산으로 버틸 수 있는 상권이 어디인지 알 수 있습니다.",
    cta: "상권 추천받기",
    to: "/",
  },
  {
    ...
    description: "우리 가게 근처에 얼마나 많은 경쟁점이 있는지, 고객은 어디서 오는지 확인합니다.",
    cta: "경쟁 분석 시작",
    to: "/compare",
  },
  {
    ...
    description: "후보 입지 여러 곳을 한 번에 비교하고 경쟁사 출점 현황을 파악합니다.",
    cta: "솔루션 문의하기",
    to: "/compare",
  },
];
